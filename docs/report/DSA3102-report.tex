...
Learning to program in Ada along the way, as well as building the the ravenscar runtime library and the library for the NRF52840, was great, is guaranteed to prove very useful knowledge in the future. 
...
\begin{itemize}
	...
	\item Including unused libraries in the Ada source-code makes the arduino crash under runtime.
